                ...
                <div class="container-fluid">
                    ...
                    <div class="painel_listagem_email">
                        <div class="col-md-11 text-center" style="margin:0 auto; height:30px; margin-top: 2vh;">
                            <label class="title_cartoes_pendentes text-title-table class_title">LISTAGEM DE EMAIL</label>
                        </div>
                        <div class="col-md-11" style="margin:0 auto;">
                            <div class="col-md-12 text-left" style=" background-color:#0069D9;
                                ...
                                <input type="text" name="email_list" class="text-input-table class_border_input" id="doc" placeholder="descricao@email.com.br" onkeyup="loadingData()">
