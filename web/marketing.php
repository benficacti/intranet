...
<html>
    ...
    <body>
        <div class="d-flex backbenfacil" id="wrapper">
            ...
            <!-- Sidebar -->
            <?php
            $page = 'marketing'; // HABILITAR MENU NA TELA ATUAL
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    <div class="col-md-11 text-center" style="margin:0 auto; height:30px; margin-top: 2vh;">
                        ...
                        <label class="title_cartoes_pendentes text-title-table"><i class="fas fa-users"></i> MÍDIAS</label>
                    </div>
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel"  style="text-align: center">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img src="img/midia1.png" alt="First slide" style="height: 422px; width: 422px">
                                            </div>
                                            <div class="carousel-item">
                                                <img  src="img/midia2.png" alt="Second slide" style="height: 422px; width: 422px">
                                            </div>
                                            <div class="carousel-item">
                                                <img  src="img/midia3.png" alt="Third slide" style="height: 422px; width: 422px">
                                            </div>
                                        </div>
                        ...
                        data: {request: 'auth_user',
                            ...
                            obj.forEach(function (name, value) {
                                if (name.RESULT === 'TRUE') {
                                    ...
                                    location.href = 'marketing_gerencial';
                                } else {
