...
/*
  ...
  echo $carteira[$chave] = $valor['Name'] . '   -   ' . $valor['Mobile'] . '   -   ' . $valor['GaragemId'] . '   -   ' . $valor['SetorId'] .'<br/>';
  $num_telefone = $valor['Mobile'];
  $id_garagem = $valor['GaragemId'];
  $id_setor_telefone = $valor['SetorId'];
  $telefone = new telefone(null, $num_telefone, $id_operadora,
  $id_status, $id_garagem, $id_tipo_telefone, $id_setor_telefone,
  null);
  $repositorio3->salvarTelefone($telefone);
  }
  //print_r($nota);
